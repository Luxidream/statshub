#' mymlnorm2
#'
#' Maximum likelihood function from Lab 10
#'
#' @param x Values of x
#' @param mu mu
...
#' @return List with x,coord,maxl
#'
#' @examples mymlnorm2(x=c(5,7,7,8,10),mu=seq(5,10,length=1000),sig=seq(0.1,4,length=1000),lwd=2,labcex=1)
#'
#'
#'
#' @export
...
mymlnorm2=function(x,mu,sig,...){  #x sample vector
